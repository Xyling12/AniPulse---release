...
import com.anipulse.app.data.anilibria.AnilibriaApi
...
object NetworkModule {
    ...
    @Provides
    @Singleton
    fun gateway(client: OkHttpClient): com.anipulse.app.data.GatewayApi =
        retrofit(client, Api.GATEWAY).create(com.anipulse.app.data.GatewayApi::class.java)
}
